...
### 4. Ждем несколько минут и смотрим на результат
   ...
   Если все сделано корректно, открыв файл script.log спустя несколько минут мы обнаружим в нем несколько строчек с надписью "hello", их количество будет зависеть от количества прошедшего времени.
